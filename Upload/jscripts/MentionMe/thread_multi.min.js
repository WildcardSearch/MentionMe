...
function load(){if(use_xmlhttprequest==1){$.ajax({type:'get',url:'xmlhttp.php',data:{action:'mentionme',mode:'getMultiMentioned',load_all:1,},success:insert,});return false;}
return true;}
