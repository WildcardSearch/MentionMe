...
var MultiMention = {
	...
	loadMultiMentioned: function()
	{
		if(use_xmlhttprequest == 1)
		{
			...
			new Ajax.Request('xmlhttp.php?action=get_multi_mentioned&load_all=1', {method: 'get', onComplete: function(request) {MultiMention.multiMentionedLoaded(request); }});
			return false;
		}
		else
		{
	...
	multiMentionedLoaded: function(request)
	{
		...
		MultiMention.clearMultiMentioned();
		$('quickreply_multi_mention').hide();
...
Event.observe(document, 'dom:loaded', MultiMention.init);